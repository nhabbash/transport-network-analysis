...
S = \frac{N_{GCC}}{N}*100
$$
Where $N_{GCC}$ is the number of vertices in the GCC and $N$ is the number of nodes in the graph. The effectiveness of the attack scenario will be judged by their impact on the value of $S$.

TODO: add graphs of the attacks, considerations on the most effective strategies, graph of varying path lengths for the most effective attack, considerations on the varying path lenghts
